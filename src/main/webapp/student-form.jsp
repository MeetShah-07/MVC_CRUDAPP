<%@page language="java" import="com.meetshah.crudapp.model.Student"%>
  <html>
     <head>
...
(student!=null ? student.getName() : "") %>"
         ...
         <div class="mb-3">
            ...
            <input type="email" name="email" class="form-control"
                value="<%= (request.getParameter("email")!=null) ? request.getParameter("email") : (student!=null ? student.getEmail() : "") %>" placeholder="Enter Email" required>
        ...
        <div class="mb-3">
             ...
             <input type="text" name="mobile" class="form-control"
                 value="<%= (request.getParameter("mobile")!=null) ? request.getParameter("mobile") : (student!=null ? student.getMobile() : "") %>"placeholder="Enter Mobile" required  \\
                  pattern="[0-9]{10}"
